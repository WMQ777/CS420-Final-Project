...
every image row as a sequence of pixels. Because MNIST image shape is 45*45px,
we will then handle 45 sequences of 45 steps for every sample.
'''
...
# Plot the loss and accuracy of biRNN
plt.figure()
