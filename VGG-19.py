...
def cnn_model_fn(features, labels, mode):
    ...
    pool3 = tf.layers.max_pooling2d(inputs=conv3_4, pool_size=[2, 2], strides=2, padding="same")
    ...
    pool4 = tf.layers.max_pooling2d(inputs=conv4_4, pool_size=[2, 2], strides=2, padding="same")
    ...
    pool5 = tf.layers.max_pooling2d(inputs=conv5_4, pool_size=[2, 2], strides=2, padding="same")
...
mnist_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn,
                                          model_dir="/tmp/mnist_vgg19_5000_model")
